...
public class ListaIngreso extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ingreso.setOnClickListener(v -> {
            Intent intent1 = new Intent(ListaIngreso.this, ListaIngreso.class);
            startActivity(intent1);
        });
        egreso.setOnClickListener(v -> {
            Intent intent1 = new Intent(ListaIngreso.this, ListarEgreso.class);
            startActivity(intent1);
        });
        resumen.setOnClickListener(v -> {
            Intent intent1 = new Intent(ListaIngreso.this, Resumen.class);
            startActivity(intent1);
        });
